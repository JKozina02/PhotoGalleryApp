...
fun AlbumsGrid(
    ...
    val showAlbumEditModal = remember { mutableStateOf(false) }
    ...
    if (showAlbumEditModal.value) {
        ModalBottomSheet(
            onDismissRequest =  {
                showAlbumEditModal.value = false
            },
            ...
            selectedAlbum.value?.let { album ->
                AlbumEditorPopup(
                    album = album,
                    onDismissRequest = { showAlbumEditModal.value = false },
