package com.photogalleryapp.composable.screens
...
import com.photogalleryapp.composable.AlbumsGrid
import com.photogalleryapp.composable.CreateAlbumPopup
...
fun AlbumsScreen(viewModel: MainViewModel){
    ...
    if(showCreateAlbumPopup){
        CreateAlbumPopup(
            onConfirm = {
                    albumName, albumColor -> viewModel.insertAlbum(
                AlbumObject(name = albumName, color = albumColor
                ))
